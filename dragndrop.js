    ...
    if ( event.target.className == "inDet" ) {
        ...
        detH.insertAdjacentHTML("afterend", 
            `<div id="dtWrp" class="detWrapper">
                ...
                <div class="inpHolder">
                    <p>Количество:</p>
                    <button id="buttPlus"><img src="plus.png" width="25px" height="25px"></button>
                    <input id="inpAmount" type="number" min="0" value="1" readonly>
                    <button id="buttMinus"><img src="minus.png" width="25px" height="25px"></button>
                    <p>Цена:</p>
                    <input id="inpPrice" type="number" min="0" value="${descrip[num][1]}" readonly>
                    <button id="buttReject"><img src="reject.png" width="25px" height="25px"></button>
                    <button id="buttAccept"><img src="accept.png" width="25px" height="25px"></button>
                </div>
            </div>`);
                ...
                dropWrap.insertAdjacentHTML("beforeend", 
                    `<div id="basket">
                        ...
                        <div>
                            ...
                            <button class="baskDelete"><img src="reject.png" width="50px" height="50px"></button>
                        </div>
                        <div id="baskTotal">
                            <p>Цена корзины:</p>
